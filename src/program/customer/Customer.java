...
public class Customer implements Comparable<Customer>, Serializable {
			...
			public Customer(String customerNumber, String customerName, int firstHalf, int secondHalf) {
				this(customerNumber, customerName, firstHalf, secondHalf, 0, 0.0, null, "");
			}

			public Customer(String customerNumber, String customerName, int firstHalf, int secondHalf,
					int totalPurchase, double avgPurchase, String grade, String deleteDate) {
				super();
